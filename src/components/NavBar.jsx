  ...
  return (
    <header className="bg-transparent px-10 fixed left-0 top-0 right-0">
      <nav className="flex flex-row items-center justify-between h-20 ">
        ...
        <ul className="flex flex-row text-lg items-center gap-4 whitespace-nowrap text-white  cursor-pointer">
          <li>TV Shows</li>
          <li>Movies</li>
          <li>Population</li>
          <li>My List</li>
        </ul>
        <img className="w-12 rounded-sm  cursor-pointer" src={pf} alt="pf" />
      </nav>
    </header>
  );
};
